...
let htmlContent = "";
for (const item of (0, _galleryItems.galleryItems))htmlContent += `<li class="gallery__item">
...
const handleClick = (e1)=>{
    e1.preventDefault();
    if (!e1.target.classList.contains("gallery__image")) return;
    console.log(e1);
    const source = e1.target.dataset.src;
    console.log(source);
